...
import { BarChart2, Users, RefreshCw, Loader2, CheckCircle, XCircle, Send, Download, Calendar, Search, ClipboardList, FileText, Bell, PlusCircle } from 'lucide-react';
                ...
                <table className="w-full text-xs text-center border-collapse min-w-[1200px]">
                  ...
                  <tbody>
                    {reportesFiltrados.map((r, i) => {
                      ...
                      return (
                        <tr key={r.id} className="hover:bg-indigo-50/30 border-b border-gray-100 transition-colors">
                          ...
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantHermanos||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantAmigos||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantAdolescentes||0}</td>
                          <td className="px-2 py-2 border border-gray-200 font-bold bg-indigo-50 text-indigo-700">{tA}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantConvertidos||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantNinosCristianos||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantNinosAmigos||0}</td>
                          <td className="px-2 py-2 border border-gray-200 font-bold bg-indigo-50 text-indigo-700">{tN}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantVisitaConsolidacion||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantVisitaCasaDePaz||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantVisitaHogar||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantHrOracion||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantHrMep||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantHrDiscipulado||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{r.cantRetiroEspiritual||0}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{Number(r.ofrendaSabado||0).toFixed(0)}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{Number(r.ofrendaNinos||0).toFixed(0)}</td>
                          <td className="px-2 py-2 border border-gray-200 text-gray-700">{Number(r.ofrendaMiercoles||0).toFixed(0)}</td>
                  ...
                  <tfoot>
                    <tr className="bg-yellow-400 font-bold text-gray-900 border-t-2 border-gray-400">
                      ...
                      <td className="px-2 py-3 border border-gray-300">{suma(reportesFiltrados,'cantHrOracion')}</td>
                      ...
                      <td className="px-2 py-3 border border-gray-300">{reportesFiltrados.reduce((a,r)=>a+Number(r.ofrendaSabado||0),0).toFixed(0)}</td>
                      <td className="px-2 py-3 border border-gray-300">{reportesFiltrados.reduce((a,r)=>a+Number(r.ofrendaNinos||0),0).toFixed(0)}</td>
                      <td className="px-2 py-3 border border-gray-300">{reportesFiltrados.reduce((a,r)=>a+Number(r.ofrendaMiercoles||0),0).toFixed(0)}</td>
                      <td className="px-2 py-3 border border-gray-300 bg-yellow-500">{reportesFiltrados.reduce((a,r)=>a+Number(r.ofrendaSabado||0)+Number(r.ofrendaNinos||0)+Number(r.ofrendaMiercoles||0),0).toFixed(0)}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
